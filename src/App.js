...
import PollItems from './components/poll-items/poll.items.component';
  ...
  return (
    <div>
      ...
      <header className="hero">
        <img className="hero__background" srcSet={`${popefrancis} 750w, ${popefrancis2x} 1440w`} sizes="(min-width: 750px) 1440px, 100vw" src={`${popefrancis}`} alt="Pope Francis" />
        <div className="max-centered">
      ...
      <div className="max-centered">
        ...
        <aside className="banner banner-bottom" role="doc-tip" aria-label="Submit a name">
          <img srcSet={`${bgpeople} 750w, ${bgpeople2x} 1440w`} sizes="(min-width: 750px) 1440px, 100vw" className="banner__background" src={`${bgpeople}`} alt="" role="none" />
          <div className="banner__left">
